...
CREATE TABLE directory_directory (
  ...
  is_date_shown_in_result_list SMALLINT DEFAULT 0,
  is_date_shown_in_result_record SMALLINT DEFAULT 0,
  is_date_shown_in_history SMALLINT DEFAULT 0,
  is_date_shown_in_search SMALLINT DEFAULT 0,
  is_date_shown_in_advanced_search SMALLINT DEFAULT 0,
  is_date_shown_in_multi_search SMALLINT DEFAULT 0,
